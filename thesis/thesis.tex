...
% Switch to arabic numbering and start the enumeration of chapters in the table of content.
    ...
    This is possible due to the rewards hypothesis which states that every goal one can possibly think of, can be formalized by means of a numeric reward signal and be achieved by maximizing the cumulative long-term rewards~\citep{sutton_reinforcement_2018}.
