...
% Switch to arabic numbering and start the enumeration of chapters in the table of content.
    ...
    Instead of directly going through adapted traditional \gls{rl} approaches, the~\nameref{ch:deep-reinforcement-learning} chapter starts with an introduction to \gls{nn} and \gls{dl}.
    ...
    As mentioned in subsection on~\nameref{subsec:the-basic-architecture-of-neural-networks}, the sign function allows for binary classification of class labels.
    ...
    In the previous subsection on~\nameref{subsec:the-basic-architecture-of-neural-networks}, a generic loss function $E(\bar{\mathbf{X}})$ has been introduced.
    ...
    As mentioned in the introduction to the chapter~\nameref{ch:deep-reinforcement-learning}, only \gls{mlp}s with their ability to chain multiple functions allow for the approximation of a complex value function for a high dimensional state-space.
    ...
    %TODO either write section on backpropagation or write short notice that learning is different
    %TODO pseudo code from deep learning book godwell
    ...
    \footnotetext{https://spinningup.openai.com/en/latest/spinningup/rl_intro2.html}
