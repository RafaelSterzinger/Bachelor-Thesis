...
% Switch to arabic numbering and start the enumeration of chapters in the table of content.
    ...
    This final addition divides the \gls{rl} problem spectrum in to two parts: model-free and model-based approaches~\citep{sutton_reinforcement_2018}.
    ...
    This spares the necessity of creating a trainings dataset with corresponding state-action pairs beforehand and thus, \gls{rl} is the preferred choice in cases where an agent interacts with and influences its environment.
    ...
    However, this is not applicable for \gls{rl} because the agent has to maximize a reward function and not to find structure in data and therefore, \gls{rl} is rightfully classified as a third subfield of \gls{ml}~\citep{sutton_reinforcement_2018}.
    ...
    \begin{figure}[h]
        ...
        \caption{The \gls{rl} framework in a \gls{mdp}~\cite[\p{48}]{sutton_reinforcement_2018}}
